...
export default function SettingsSidebar({ variant = 'vertical' }: SettingsSidebarProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    {
      id: 'benefits',
      labelKey: 'settings.menu.myBenefits',
      href: '/settings/my-benefits',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      id: 'account',
      labelKey: 'settings.menu.myAccount',
    ...
    {
      id: 'coupon',
      labelKey: 'settings.menu.myCoupon',
    ...
    {
      id: 'messages',
      labelKey: 'settings.menu.messageCenter',
