...
interface AiVideoPageContentProps {
  locale: string;
}

export default function AiVideoPageContent({ locale }: AiVideoPageContentProps) {
  const content = AI_VIDEO_CONTENT[locale] || AI_VIDEO_CONTENT.en;
