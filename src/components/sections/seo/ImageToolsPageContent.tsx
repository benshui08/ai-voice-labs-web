...
export default function ImageToolsPageContent({ locale }: ImageToolsPageContentProps) {
  const content = IMAGE_TOOLS_CONTENT[locale] || IMAGE_TOOLS_CONTENT.en;
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      {/* Tools Showcase */}
      <ImageToolsShowcase locale={locale} />
