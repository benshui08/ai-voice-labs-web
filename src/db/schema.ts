...
export const luckyDrawInstances = sqliteTable("lucky_draws", {
	id: integer().primaryKey({ autoIncrement: true }),
	...
	uniqueIndex("uq_ld_draw_id").on(table.drawId),
	index("idx_ld_product_id").on(table.productId),
	index("idx_ld_enabled_status").on(table.enabled, table.status),
]);

export const luckyDrawEntries = sqliteTable("lucky_draw_entries", {
	id: integer().primaryKey({ autoIncrement: true }),
	drawId: text("draw_id").notNull(),
	userId: text("user_id").notNull(),
	...
	index("idx_lde_draw_user").on(table.drawId, table.userId),
	uniqueIndex("uq_lde_draw_slot").on(table.drawId, table.slotNumber),
]);

export const luckyDrawResults = sqliteTable("lucky_draw_results", {
	id: integer().primaryKey({ autoIncrement: true }),
	drawId: text("draw_id").notNull(),
...
export const luckyDrawClaims = sqliteTable("lucky_draw_claims", {
	id: integer().primaryKey({ autoIncrement: true }),
	drawId: text("draw_id").notNull(),
	userId: text("user_id").notNull(),
	status: text("status").notNull(),
	...
	index("idx_ldc_user_id").on(table.userId),
]);
